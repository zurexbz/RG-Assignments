...
describe('mostRecommended', () => {
    ...
    it('returns game with the best ratings by game genre', () => {
        ...
        expect(mostRecommended(games2)).toEqual({
            simulation: { title: 'Cities: Skylines', genre: 'simulation', developer: 'Colossal Order', rating: 9.4 },
            firstPersonShooter: { title: 'Far Cry 5', genre: 'firstPersonShooter', developer: 'Ubisoft Montreal', rating: 8.9 },
            racing: { title: 'Hot Wheels Unleashed', genre: 'racing', developer: 'Milestone', rating: 9.2 }
        });
    })
})
